...
// Enhanced toast component with icon and better layout
...
// Preset toast components for common use cases
export const SuccessToast = React.forwardRef<
    React.ElementRef<typeof EnhancedToast>,
    Omit<React.ComponentPropsWithoutRef<typeof EnhancedToast>, 'variant'>
>((props, ref) => (
    <EnhancedToast ref={ref} variant="success" {...props} />
))
SuccessToast.displayName = "SuccessToast"

export const ErrorToast = React.forwardRef<
    React.ElementRef<typeof EnhancedToast>,
    Omit<React.ComponentPropsWithoutRef<typeof EnhancedToast>, 'variant'>
>((props, ref) => (
    <EnhancedToast ref={ref} variant="error" {...props} />
))
ErrorToast.displayName = "ErrorToast"

export const WarningToast = React.forwardRef<
    React.ElementRef<typeof EnhancedToast>,
    Omit<React.ComponentPropsWithoutRef<typeof EnhancedToast>, 'variant'>
>((props, ref) => (
    <EnhancedToast ref={ref} variant="warning" {...props} />
))
WarningToast.displayName = "WarningToast"

export const InfoToast = React.forwardRef<
    React.ElementRef<typeof EnhancedToast>,
    Omit<React.ComponentPropsWithoutRef<typeof EnhancedToast>, 'variant'>
>((props, ref) => (
    <EnhancedToast ref={ref} variant="info" {...props} />
))
