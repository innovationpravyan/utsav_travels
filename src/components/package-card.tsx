...
import { Calendar, Tag, ArrowRight, Clock, MapPin, Star, Users, Sparkles } from "lucide-react";
...
/**
 * Enhanced Package Card with advanced effects
 */
export function PackageCard({ 
  ...
  const mouseParallax = useMouseParallax(0.15, true);
  ...
  return (
    ...
    >
      <Link href={`/packages/${pkg.id}`} className="block h-full">
        ...
        >
          <GlassCard
            variant={variant === 'premium' ? 'gradient' : 'default'}
            animation="liquid"
            interactive
            glow
            className={cn(
              "h-full w-full p-0",
              variant === 'premium' && "bg-gradient-to-br from-yellow-400/20 via-orange-500/10 to-red-500/20"
            )}
          >
            ...
            <div className="relative h-full w-full overflow-hidden rounded-inherit">
              ...
              {/* Hover Overlay with Package Theme */}
              <motion.div
                className={cn(
                  "absolute inset-0",
                  variant === 'premium' 
                    ? "bg-gradient-to-br from-yellow-400/30 via-transparent to-orange-500/20"
              ...
              {/* Content Overlay */}
              <div className={cn("absolute inset-0 flex flex-col justify-between", styles.content)}>
                  ...
                  {variant === 'premium' && (
                    ...
                    >
                      <GlassCard
                        variant="gradient"
                        size="sm"
                        className="px-3 py-1.5 bg-gradient-to-r from-yellow-400/30 to-orange-500/30"
                      >
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <div className="absolute inset-4 border border-white/30 rounded-lg shadow-2xl" />
              </motion.div>
              ...
              {!imageLoaded && (
                <div className="absolute inset-0 bg-gradient-to-br from-slate-800 to-slate-900 animate-pulse">
                  ...
                  <div className={cn("absolute bottom-0 left-0 right-0", styles.content)}>
