    ...
    return (
        <footer className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
            ...
            <div className="absolute inset-0 opacity-5">
                <div
                    className="w-full h-full bg-[radial-gradient(circle_at_1px_1px,_white_1px,_transparent_1px)] bg-[length:32px_32px]"/>
            </div>
                                ...
                                <OptimizedMotionDiv preset="slideUp">
                                    <div className="space-y-4">
                                        ...
                                        <Link href="/" className="flex items-center gap-2 group">
                                            <Plane
                                                className="h-8 w-8 text-primary group-hover:rotate-12 transition-transform duration-200"/>
                                            <div>
                                                <span
                                                    className="text-2xl font-bold text-gradient">{COMPANY_INFO.name}</span>
